...
const stats = [
  { id: 1, label: 'Years', info: 'building Data and AI solutions across diverse industries', value: 6 },
  { id: 2, label: 'Customers', info: 'enabled to make data-informed decisions', value: 10 },
  { id: 3, label: 'Solutions', info: 'architected and delivered sucessfully', value: 35 },
  { id: 4, label: 'Revenue', info: 'generated by delivering the fit-for-purpose solutions', value: 3 },
];
